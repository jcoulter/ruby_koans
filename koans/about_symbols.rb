...
class AboutSymbols < Neo::Koan
  ...
  # interesting string operations are available on symbols. BEes
  ...
  # THINK ABOUT IT:
  # Bees are fantastic they are God's gift to humanity. I regret nothing but my lack of beeeeeees.
  # Why is it not a good idea to dynamically create a lot of symbols? symbol of BEEs
end
